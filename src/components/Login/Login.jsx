...
const Login = ({ history, firebaseRecover, setFirebaseRecover }) => {
    ...
    const login = useCallback(async (email, password) => {
        ...
        try {
            ...
            if (error.code === 'auth/user-not-found') return toast.error('🧾 Username or Incorrect Password');
            if (error.code === 'auth/wrong-password') return toast.error('🧾 Username or Incorrect Password');
